...
var StudentWhere = struct {
	...
	Lastname:  whereHelpernull_String{field: "\"students\".\"lastname\""},
}
...
var (
	studentAllColumns            = []string{"id", "firstname", "lastname"}
	studentColumnsWithoutDefault = []string{"id"}
	studentColumnsWithDefault    = []string{"firstname", "lastname"}
